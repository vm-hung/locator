...
const (
	RaftTransportService_Send_FullMethodName   = "/locator.transport.RaftTransportService/Send"
	RaftTransportService_Stream_FullMethodName = "/locator.transport.RaftTransportService/Stream"
)
...
type RaftTransportServiceClient interface {
	...
	Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamDataRequest, StreamDataResponse], error)
}
...
func (c *raftTransportServiceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[StreamDataRequest, StreamDataResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RaftTransportService_StreamClient = grpc.ClientStreamingClient[StreamDataRequest, StreamDataResponse]
...
type RaftTransportServiceServer interface {
	...
	Stream(grpc.ClientStreamingServer[StreamDataRequest, StreamDataResponse]) error
...
func (UnimplementedRaftTransportServiceServer) Stream(grpc.ClientStreamingServer[StreamDataRequest, StreamDataResponse]) error {
...
func _RaftTransportService_Stream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RaftTransportServiceServer).Stream(&grpc.GenericServerStream[StreamDataRequest, StreamDataResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RaftTransportService_StreamServer = grpc.ClientStreamingServer[StreamDataRequest, StreamDataResponse]
...
var RaftTransportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "locator.transport.RaftTransportService",
	...
	Metadata: "protos/transport/transport.proto",
}
